...
const locators = {
    PreviewContent: {
        ...
        value: '//*[@id="page-top"]/div[3]/div[2]/div[4]/div/div[6]/app-library-tile/div[3]/a'
    },
    ...
    Videosendingchoosebtn: {
        type: IdentificationType[IdentificationType.Xpath],
        value: '//*[@id="page-top"]/div[3]/div[2]/div[4]/div/div[6]/app-library-tile/div[3]/button'
    },
...
export class Communicationmanagervideosendingpage extends WebAppCommon {
    ...
    async Videosendingchoosebtn() {

       browser.sleep(2000);
       await this.clickElement(locators.Videosendingchoosebtn);
    ...
    async  IndividualEmailID() {
     ...
     async performEnteremailaddressbox() {
        ...
        await element(by.xpath(('/html/body/app-boot/app-home/app-campaign-email-content/div/div/div[2]/div/div/div/div/div/div/form/div[6]/tag-input/div/div/tag-input-form/form/input'))).sendKeys('chandrababu.kakani@lrn.com');
    }
