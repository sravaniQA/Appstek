...
const locators = {
    PreviewContent: {
        ...
        value: '//*[@id="page-top"]/div[3]/div[2]/div[4]/div/div[16]/app-library-tile/div[3]/a'
    },
    ...
    AnimatedGIFsendingchoosebtn: {
        type: IdentificationType[IdentificationType.Xpath],
        value: '//*[@id="page-top"]/div[3]/div[2]/div[4]/div/div[16]/app-library-tile/div[3]/button'
    },
...
export class CommunicationmanagerAnimatedGIFsendingpage extends WebAppCommon {
    ...
    async AnimatedGIFsendingchoosebtn() {

       browser.sleep(2000);
       await this.clickElement(locators.AnimatedGIFsendingchoosebtn);
